        ...
        <div className="flex flex-col gap-2 w-full md:w-auto">
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg font-bold shadow-md"
            >
              検索
            </button>
          </div>
            ...
            {records.map((r) => (
              ...
              >
                ...
                <td className="p-4 font-black">
                  PT-{r.patient?.id?.toString().padStart(4, "0")}
                </td>
                <td className="p-4">
                  <span
